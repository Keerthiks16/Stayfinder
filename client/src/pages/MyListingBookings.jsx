...
const MyListingBookings = () => {
  ...
  if (loading && !propertyBookings?.length) {
    return (
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center p-4">
        ...
        <div className="flex gap-4">
          ...
          <button
            onClick={() => getMyPropertyBookings(filters)}
  ...
  if (!propertyBookings?.length && !loading) {
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center p-4">
      ...
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage all bookings for your listed properties
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {formatPrice(booking.listing.pricePerDay)}/night
                      </p>
                    </div>
                  </div>
                </div>
        ...
        {/* Pagination */}
        {propertyPagination && propertyPagination.totalPages > 1 && (
          <div className="flex justify-center mt-8">
            <div className="flex items-center gap-2">
              <button
                onClick={() =>
                  handlePageChange(propertyPagination.currentPage - 1)
                }
                disabled={!propertyPagination.hasPrev}
                className={`p-2 rounded-full ${
                  propertyPagination.hasPrev
              ...
              <div className="flex items-center gap-1">
                {Array.from(
                  { length: propertyPagination.totalPages },
                  (_, i) => i + 1
                ).map((page) => (
                  <button
                    key={page}
                    ...
                    className={`w-10 h-10 rounded-full ${
                      page === propertyPagination.currentPage
